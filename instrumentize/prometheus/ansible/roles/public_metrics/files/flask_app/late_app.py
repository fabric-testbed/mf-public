...
late_app = Dash(external_stylesheets=[dbc.themes.BOOTSTRAP], url_base_pathname='/latency/')
...
if __name__ == "__main__":
    ...
    late_app.run_server(host='0.0.0.0', debug=True, use_reloader=False)

    # If running on a remote node    
    #late_app.run_server(host='0.0.0.0',debug=False, use_reloader=False)
